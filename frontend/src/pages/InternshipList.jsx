...
const InternshipList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-zinc-50 dark:from-zinc-950 dark:to-zinc-900">
      {/* Hero Section – mobile padding reduced */}
      <div className="bg-indigo-600 dark:bg-indigo-900 text-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Briefcase className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 opacity-80" />
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold mb-2 sm:mb-3 tracking-tight">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        {/* Search + Filter Bar */}
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 p-4 mb-8 sm:mb-10">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl py-3 pl-12 pr-4 text-base focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all"
              />
            </div>
            {/* Filter buttons – scrollable on mobile, larger touch area */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
          ...
          {user && (
            <Link
              to="/post-internship"
              className="flex items-center justify-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold text-sm transition-all shadow-md hover:shadow-lg w-full sm:w-auto"
            >
            ...
            {pagination.total > pagination.limit && (
              <div className="flex flex-wrap justify-center gap-3 mt-10 sm:mt-12">
                <button
                  ...
                  className="px-5 py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 disabled:opacity-40 text-sm font-medium min-w-[100px]"
                >
                  Previous
                </button>
